...
export default function Notification() {
	...
	if (!userNotifications || userNotifications == []) return <h1 className="text-center mt-2 mx-auto">Loading , Please Wait .</h1>

	return (
		<div className={`col-span-7 md:col-span-4 lg:col-span-3 h-full justify-center flex-col justify-center items-center ${scrollbar}`}>
			<div className="w-full h-full px-2 ">

				<h1 className="text-left text-xl dark:text-gray-50 font-bold py-1">Notifications</h1>

				<div onClick={readAllNotifications} className="h-9 w-full mb-2 dark:bg-gray-700 dark:text-blue-400 text-sky-600 bg-gray-200 justify-center flex items-center "> Mark All as Read </div>
