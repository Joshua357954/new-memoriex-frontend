	...
	return (
		<div className="w-full h-full h-16">
			<div onClick={() => navigate(`/profile/${name}`)} className="flex w-full px-2 py-1 items-center justify-start space-x-2">	
				{/*{ img ? */}
				<div className="w-14 h-14 flex justify-center border-[1px] border-white items-center rounded-full">
						  <img src={img || Pix} className="w-full h-full rounded-full" alt="User Pix" />
				 </div> 
				{/*	:
