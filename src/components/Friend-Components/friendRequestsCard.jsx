	...
	return (
		<div className="w-full h-16 dark:bg-gray-600 bg-gray-100 mb-[5px] rounded-md  flex justify-between px-[6px] items-center">
			...
			<div className="flex justify-between mr-1 space-x-2 w-19 dark:text-gray-100 text-gray-800">
				<div onClick={loading ? "" : acceptUrRequest} className="px-3 py-3 rounded-md dark:bg-gray-600 shadow bg-gray-300"><Check/></div>
				<div onClick={loading ? "" : declineRequest} className="px-3 py-3 rounded-md dark:bg-gray-600 shadow bg-gray-300"><Trash/></div>
			</div>	
